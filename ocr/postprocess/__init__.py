...
def build_post_process(config, global_config=None):
    support_dict = ['DBPostProcess', 'CTCLabelDecode', 
                    'AttnLabelDecode', 'ClsPostProcess',
                    'TableLabelDecode','VQASerTokenLayoutLMPostProcess',
                    'VQAReTokenLayoutLMPostProcess', 'DistillationSerPostProcess', 
                    'DistillationRePostProcess', 'PicoDetPostProcess'
                ]
